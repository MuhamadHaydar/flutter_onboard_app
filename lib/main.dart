...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget _buildImage(String assetName) {
    return Align(
      child: Image.asset('images/$assetName.png',width: 350, height: 300,),
  ...
  Widget build(BuildContext context) {
    ...
    List<Color> indecatorColors = [Colors.red,Colors.yellow,Colors.blue,Colors.green];
    ...
    return IntroductionScreen(
      pages: [
        ...
        PageViewModel(
          title: "Points!",
          body: 'You can be the best by collect whole of points through the week.',
